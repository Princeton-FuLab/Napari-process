...
# video setting
fps = 30
video_path = 'Z:\Tian-Ming_Fu\Files_from_Janelia\LLS/20201209_LLS\LLCPK1_ER-mEmerald-H2B-mCherry/video/output_video_cell3_2.mp4'
image_path = 'Z:\Tian-Ming_Fu\Files_from_Janelia\LLS/20201209_LLS\LLCPK1_ER-mEmerald-H2B-mCherry/video/'
...
for tiff_file_1, tiff_file_2 in zip(cell3_488, cell3_560):
    ...
    layer1 = viewer.add_image(frame488_corrected, name='488', colormap=membrane_cmap,
                              contrast_limits=[0, first_max488 / 4], opacity=1, gamma=0.85, scale=[1.85, 1, 1])
    layer2 = viewer.add_image(frame560_corrected, name='560', colormap=nucleus_cmap,
                              contrast_limits=[0, first_max560], opacity=0.6, gamma=0.85, scale=[1.85, 1, 1])
...
# cell3_cont viewing
zoom = np.linspace(start=0.5, stop=2.3, num=240)
zoom = np.concatenate((zoom, np.linspace(start=2.3, stop=2.3, num=200)), axis=0)
